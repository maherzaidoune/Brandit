...
class MainPage extends Component {
  ...
  constructor(props){
    super(props);
    this.state={
      mask: this.props.mask.map(v => {
        "https://brandit.tn/admin/" + v.image;
      })
    }
  }
  _takePhoto = () => {
  ...
  _openLibrary = () => {
    ...
    ImagePicker.launchImageLibrary(options, this.state.maskresponse => {
      console.log(response);
      ImageEdit({
        path: response.path,
        Stickers: this.state.mask
